...
$checkRaffle = mysql_query("SELECT * FROM events WHERE event_type = '0' AND event_id = '$raffle_id'");
...
<head>
    ...
    <meta charset='utf-8'>
    <meta name="description" content="Мы рады представить Вам наш дополнительный розыгрыш на free-cheese.com. Как мы уже упоминали, 1 октября сайт начинает полностью функционировать и разыгрывать подарки. Бесплатный сыр только у нас.">
                        ...
                        echo '
                            <div class="bodyLeft">
                                <div class="mainRaffle">
                                    <img src="'.$ruffle_img.'" alt="Дополнительный розыгрыш">
                                    <span class="aboutUs">
                                    '.$redBut.$ruffle_text.'
                                    ...
                                    <div class="raffleBottom green">
                                        <div class="raffleBottomContent">
                                            <span>Дополнительный розыгрыш</span>
                                        </div>
                                    </div>
                                </div>
