...
<html>
<head>
    <title>Контакты | free-cheese.com</title>
    <meta charset='utf-8'>
    <meta name="description" content="Свяжитесь с нами. Free-cheese.com - бесплатный сыр только у нас.">
...
<?php echo $server_answer; $_SESSION['server_answer'] = '' ?>
    <div class="container">
        ...
        <div class="body">
            ...
            <div class="aboutUs">
                <?php
                $checkContent = mysql_query("SELECT * FROM contents WHERE content_page = 'contacts'");
